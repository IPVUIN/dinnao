...
const CHANNELS = [
  ...
  },
  {
    id: "shopee",
    label: "Shopee",
    desc: "สั่งออนไลน์ ส่งถึงบ้าน",
    href: LINKS.shopee,
    colorClass: "bg-shopee",
    icon: (
...
export default function Channels() {
  return (
    <section className="channels" id="channels">
      <div className="wrap">
        <span className="eyebrow center">ช่องทางการสั่งซื้อ</span>
        <h2 className="center" data-reveal>เลือกช่องทางที่คุณสะดวก</h2>
